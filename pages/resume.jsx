...
const resume = () => {
  return (
    <>
      <Head>
        <title>Creative Corner | Services</title>
        <meta
          name='description'
          content=''
        />
      ...
      <div className='max-w-[940px] cctext mx-auto p-2 pt-[120px]'>
        <h2 className='text-center'>Services</h2>
        <div className='bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center'>
          <h2 className='text-center'>Creative Corner</h2>
          <div className='flex'>
            <a
              href=''
              target='_blank'
        ...
        <div className='text-center py-4 text-xl font-bold uppercase tracking-wider'>
          <div className='hidden sm:block'>
            <p>
              Graphics Designing <span className='px-1'>|</span> Web Development{' '}
              <span className='px-1'>|</span> Digital Marketing
            </p>
          </div>
        ...
        <p>
          Analytical, innovative, and motivated web development professionals
